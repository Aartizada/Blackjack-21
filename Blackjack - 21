...
class Card:
    def __init__(self,suit,rank):
        ...
        self.rank = rank
    def __str__(self):
        return self.rank + ' of ' + self.suit # setting up a readable list of cards.
...
class Deck:
    ...
    def shuffle(self): #define shuffle and deal commands
        random.shuffle(self.deck)
    def deal(self):
        single_card = self.deck.pop()
        return single_card
# If you want to print a "test deck" use this code below.
# test_deck = Deck()
# print(test_deck)
...
class Hand:
    ...
    def adjust_for_ace(self):
        pass
#T testing a hand. Firswt printing the value of the hand, and then naming the cards in the hand.
#test_deck = Deck()
#test_deck.shuffle()
#test_player = Hand()
